...
MAPPING = {
    '회기_GLAM': './Crawling/resource/kyunghee_glam.json',
    '인천_GLAM': './Crawling/resource/incheon_glam.json',
}
with open('./Prompts/prompt_1shot.pickle', 'rb') as f:
...
def run_demo():
    demo = gr.Interface(
        fn=fn,
        inputs=[gr.Radio(['회기_GLAM','인천_GLAM'], label='숙소')],
